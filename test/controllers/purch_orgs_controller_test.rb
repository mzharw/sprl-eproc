...
class PurchOrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purch_org" do
    assert_difference("PurchOrg.count") do
      post purch_orgs_url, params: { purch_org: { code: @purch_org.code, from_date: @purch_org.from_date, party_id: @purch_org.party_id, thru_date: @purch_org.thru_date } }
    end
  ...
  test "should update purch_org" do
    patch purch_org_url(@purch_org), params: { purch_org: { code: @purch_org.code, from_date: @purch_org.from_date, party_id: @purch_org.party_id, thru_date: @purch_org.thru_date } }
