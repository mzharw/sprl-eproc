...
class MeasurementUnitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement_unit" do
    assert_difference("MeasurementUnit.count") do
      post measurement_units_url, params: { measurement_unit: { app_id: @measurement_unit.app_id, created_at: @measurement_unit.created_at, created_by_id: @measurement_unit.created_by_id, desc: @measurement_unit.desc, dimid: @measurement_unit.dimid, ident_name: @measurement_unit.ident_name, name: @measurement_unit.name, symbol: @measurement_unit.symbol, updated_at: @measurement_unit.updated_at, updated_by_id: @measurement_unit.updated_by_id } }
    end
