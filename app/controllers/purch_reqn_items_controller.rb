class PurchReqnItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @purch_reqn_item.save
        format.html do
          # redirect_to purch_reqn_item_url(@purch_reqn_item), notice: 'Purch reqn item was successfully created.'
          redirect_to purch_reqn_url(params[:id]), notice: 'Purch reqn item was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @purch_reqn_item.update({ **purch_reqn_item_params, **tracker('update') })
        format.html do
          redirect_to purch_reqn_url(params[:id]), notice: 'Purch reqn item was successfully updated.'
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to purch_reqn_url(params[:id]), notice: 'Purch reqn item was successfully destroyed.' }
