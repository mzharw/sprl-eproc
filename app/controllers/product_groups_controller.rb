class ProductGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_group.save
        format.html { redirect_to product_group_url(@product_group), notice: "Product group was successfully created." }
  ...
  def update
    respond_to do |format|
      if @product_group.update(product_group_params)
        format.html { redirect_to product_group_url(@product_group), notice: "Product group was successfully updated." }
  ...
  private
    ...
    def product_group_params
      params.require(:product_group).permit(:app_id, :party_id, :code, :from_date, :thru_date, :desc)
    end
end
